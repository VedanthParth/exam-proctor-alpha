      ...
      <main class=\"flex flex-col gap-[32px] row-start-2 items-center sm:items-start\">
        ...
        <ol class=\"list-inside list-decimal text-sm/6 text-center sm:text-left font-[family-name:var(--font-geist-mono)]\">
          <li class=\"mb-2 tracking-[-.01em]\">
            Get started by editing <code class=\"bg-black/[.05] dark:bg-white/[.06] px-1 py-0.5 rounded font-[family-name:var(--font-geist-mono)] font-semibold\">src/app/page.ts</code>.
          </li>
